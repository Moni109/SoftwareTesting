...
public class AppTest {
    ...
    public void testIxigoWebsite() throws Exception {
        ...
        // Step 1
        WebElement roundTripButton = wait.until(new ExpectedCondition<WebElement>() {
            @Override
            public WebElement apply(WebDriver d) {
                return d.findElement(By.xpath("/html/body/main/div[2]/div[1]/div[3]/div[1]/div[1]/div/button[2]"));
            }
        });
        roundTripButton.click();

        // Step 2
        WebElement inputFromDiv = wait.until(new ExpectedCondition<WebElement>() {
            @Override
            public WebElement apply(WebDriver d) {
                return d.findElement(By.xpath("/html/body/main/div[2]/div[1]/div[3]/div[2]/div[1]/div[1]/div[1]/div"));
            }
        });
        inputFromDiv.click();

        WebElement inputFrom = wait.until(new ExpectedCondition<WebElement>() {
            @Override
            public WebElement apply(WebDriver d) {
                return d.findElement(By.xpath("/html/body/main/div[2]/div[1]/div[3]/div[2]/div[1]/div[1]/div[2]/div/div/div[2]/input"));
            }
        });
        ...
        wait.until(new ExpectedCondition<Boolean>() {
            ...
            public Boolean apply(WebDriver d) {
                return ExpectedConditions.visibilityOfElementLocated(firstOptionSelector).apply(d);
            }
        });
        WebElement firstOption = driver.findElement(By.xpath("/html/body/main/div[2]/div[1]/div[3]/div[2]/div[1]/div[1]/div[3]/div[1]/li"));
        firstOption.click();
        Thread.sleep(2000);

        // Step 4
        WebElement inputToDiv = wait.until(new ExpectedCondition<WebElement>() {
            @Override
            public WebElement apply(WebDriver d) {
                return d.findElement(By.xpath("/html/body/main/div[2]/div[1]/div[3]/div[2]/div[1]/div[2]/div[1]/div"));
            }
        });
        inputToDiv.click();

        // Step 5
        WebElement inputTo = wait.until(new ExpectedCondition<WebElement>() {
            @Override
            public WebElement apply(WebDriver d) {
                return d.findElement(By.xpath("/html/body/main/div[2]/div[1]/div[3]/div[2]/div[1]/div[2]/div[2]/div/div/div[2]/input"));
            }
        });
        ...
        wait.until(new ExpectedCondition<Boolean>() {
            @Override
            public Boolean apply(WebDriver d) {
                return ExpectedConditions.visibilityOfElementLocated(firstOptionToSelector).apply(d);
            }
        });

        Thread.sleep(3000);

        WebElement firstToOption = wait.until(new ExpectedCondition<WebElement>() {
            @Override
            public WebElement apply(WebDriver d) {
                return d.findElement(By.xpath("/html/body/main/div[2]/div[1]/div[3]/div[2]/div[1]/div[2]/div[3]/div[1]/li"));
            }
        });
        firstToOption.click();

        // Step 6
        WebElement departure = wait.until(new ExpectedCondition<WebElement>() {
            @Override
            public WebElement apply(WebDriver d) {
                return d.findElement(By.xpath("/html/body/main/div[2]/div[1]/div[3]/div[2]/div[2]/div[1]/div/div"));
            }
        });
        departure.click();
        ...
        WebElement departureInput = wait.until(new ExpectedCondition<WebElement>() {
            @Override
            public WebElement apply(WebDriver d) {
                return d.findElement(departureSelector);
            }
        });
        ...
        WebElement returnInput = wait.until(new ExpectedCondition<WebElement>() {
            @Override
            public WebElement apply(WebDriver d) {
                return d.findElement(returnSelector);
            }
        });
        ((JavascriptExecutor) driver).executeScript("arguments[0].parentElement.click();", returnInput);

        // Step 9
        WebElement travelClass = wait.until(new ExpectedCondition<WebElement>() {
            @Override
            public WebElement apply(WebDriver d) {
                return d.findElement(By.xpath("/html/body/main/div[2]/div[1]/div[3]/div[2]/div[3]/div[1]/div"));
            }
        });
        travelClass.click();
    ...
    public void testAboutUs() throws IOException {
        ...
        // Step 2
        WebElement aboutSection = wait.until(new ExpectedCondition<WebElement>() {
            @Override
            public WebElement apply(WebDriver d) {
